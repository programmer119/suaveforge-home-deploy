(() => {
  ...
  const i18n = {
    ko: {
      "nav.diagnosis": "무료 진단", "nav.cases": "대표 사례", "nav.demos": "라이브 데모", "nav.portfolio": "전체 작업", "nav.process": "진행 방식", "nav.team": "개발팀",
      ...
      "diagnosis.title1": "URL 하나면,", "diagnosis.title2": "먼저 고칠 순서가 보입니다.", "diagnosis.lead": "회원가입 없이 공개 페이지를 실제 브라우저로 검사합니다. 성능·모바일·SEO·접근성·기본 보안을 확인하고, 근거가 있는 문제만 우선순위로 정리합니다.", "diagnosis.point1": "가입 없이 URL 하나로 시작", "diagnosis.point2": "이메일은 결과 확인 뒤 선택", "diagnosis.point3": "공개 페이지에서 확인한 사실만 사용", "diagnosis.point4": "전체 재개발보다 먼저 고칠 부분부터", "diagnosis.label": "진단할 사이트 주소", "diagnosis.button": "무료 진단 시작", "diagnosis.note1": "회원가입 불필요", "diagnosis.note2": "공개 URL만 검사", "diagnosis.note3": "내부 기능은 추측하지 않음", "diagnosis.check1": "로딩·렌더링·Core Web Vitals", "diagnosis.check2": "넘침·터치·첫 화면 배치", "diagnosis.check3": "메타·색인·문서 구조", "diagnosis.check4": "라벨·대비·ARIA·키보드", "diagnosis.check5": "HTTPS·헤더·혼합 콘텐츠",
    ...
    en: {
      "nav.diagnosis": "Free Audit", "nav.cases": "Case Studies", "nav.demos": "Live Demos", "nav.portfolio": "All Work", "nav.process": "Process", "nav.team": "Team",
    ...
    ja: {
      "nav.diagnosis": "無料診断", "nav.cases": "代表事例", "nav.demos": "ライブデモ", "nav.portfolio": "制作実績", "nav.process": "進行方式", "nav.team": "チーム",
      ...
      "diagnosis.title1": "URLひとつで、", "diagnosis.title2": "先に直す順番が見えます。", "diagnosis.lead": "登録なしで公開ページを実ブラウザで検査します。性能・モバイル・SEO・アクセシビリティ・基本セキュリティを確認し、根拠のある問題だけを優先順位で整理します。", "diagnosis.point1": "登録なし、URLひとつで開始", "diagnosis.point2": "メールは結果確認後に任意", "diagnosis.point3": "公開ページで確認できる事実だけを使用", "diagnosis.point4": "全面改修より先に直す箇所から", "diagnosis.label": "診断するサイトURL", "diagnosis.button": "無料診断を開始", "diagnosis.note1": "登録不要", "diagnosis.note2": "公開URLのみ", "diagnosis.note3": "内部機能を推測しない", "diagnosis.check1": "読み込み・描画・Core Web Vitals", "diagnosis.check2": "はみ出し・タップ・初期画面", "diagnosis.check3": "メタ・インデックス・構造", "diagnosis.check4": "ラベル・コントラスト・ARIA", "diagnosis.check5": "HTTPS・ヘッダー・混在コンテンツ",
    ...
    es: {
      "nav.diagnosis": "Auditoría gratis", "nav.cases": "Casos", "nav.demos": "Demos", "nav.portfolio": "Trabajos", "nav.process": "Proceso", "nav.team": "Equipo",
